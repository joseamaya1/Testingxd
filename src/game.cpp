	...
	const std::string& receiver, const std::string& text)
{
	...
	// HERE
	std::list<std::string> wordsList{ "calvera", "caalvera", "callvera", "calvvera", "calveera", "calverra", "baiakpesadao", "premiia", "premia", "prremia", "preemia", "premmia", "eldera", "elldera", "elddera", "eldeera", "elderra", "dolera", "dollera", "ddolerra", "doollera", "dooleera", "doleerra", "dooleerra", "doolerra", "doolera", "doleera", "doliera", "fortera", "footera", "fortiera", "auurera", "aurera", "inflame", "megatibia", "hexera", "hornera", "gunzodus", "wind", "forsaken", "legendera", "underwar" };
